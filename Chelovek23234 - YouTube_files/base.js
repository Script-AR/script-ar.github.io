...
g.Pb=function(a){if(a instanceof g.Lb)return a;a=a.Ud?a.Sc():String(a);Nb.test(a)||(a="about:invalid#zClosurez");return g.Ob(a)};
g.Qb=function(a){if(a instanceof g.Lb)return a;a=a.Ud?a.Sc():String(a);Nb.test(a)||(a="about:invalid#zClosurez");return g.Ob(a)};
...
g.ac=function(a){if(a instanceof g.Yb)return a;var b=null;a.Jl&&(b=a.C());a=g.Ua(a.Ud?a.Sc():String(a));return g.$b(a,b)};
...
g.kc=function(a,b){g.ab(b,function(b,d){b&&b.Ud&&(b=b.Sc());"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:jc.hasOwnProperty(d)?a.setAttribute(jc[d],b):g.Oa(d,"aria-")||g.Oa(d,"data-")?a.setAttribute(d,b):a[d]=b})};
...
b.Lc&&0<b.timeout&&(f=g.Df(function(){e||(e=!0,k.abort(),g.Ff(f),b.Lc.call(b.context||g.n,k))},b.timeout));
return k};
...
g.dh=function(a,b,c,d){!g.C("VISITOR_DATA")&&.01>Math.random()&&g.yf(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",ha:c,Fs:"JSON",Lc:function(){d.Lc()},
Cr:d.Lc,onSuccess:function(a,b){if(d.onSuccess)d.onSuccess(b)},
...
nba=function(){var a=window.location.protocol,b=ni.getEntriesByType("resource");b=(0,g.Xi)(b,function(b){return 0==b.name.indexOf(a+"//fonts.gstatic.com/s/")});
...
g.rh=new g.Db("undefined"==typeof window.document?null:window.document);g.rh.F=3950;g.al=g.Fb(null);var oaa;oaa=!g.B||g.yb(9);g.tca=!g.Mk&&!g.B||g.B&&g.yb(9)||g.Mk&&g.wb("1.9.1");g.bl=g.B&&!g.wb("9");g.uca=g.B||g.Bd||g.Ad;g.Ib.prototype.Ud=!0;g.Ib.prototype.Sc=function(){return this.C};
g.Ib.prototype.toString=function(){return"Const{"+this.C+"}"};
g.Hb={};g.Jb("");g.vca=RegExp("[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.wca=RegExp("^[^\u0591-\u06ef\u06fa-\u07ff\u200f\ufb1d-\ufdff\ufe70-\ufefc]*[A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]");g.cl=RegExp("^[^A-Za-z\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u02b8\u0300-\u0590\u0800-\u1fff\u200e\u2c00-\ufb1c\ufe00-\ufe6f\ufefd-\uffff]*[\u0591-\u06ef\u06fa-\u07ff\u200f\ufb1d-\ufdff\ufe70-\ufefc]");g.Lb.prototype.Ud=!0;g.Lb.prototype.Sc=function(){return this.F};
g.Lb.prototype.Jl=!0;g.Lb.prototype.C=function(){return 1};
var Nb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,Kb={};g.Ob("about:blank");g.Sb.prototype.Ud=!0;g.Rb={};g.Sb.prototype.Sc=function(){return this.C};
g.dl=g.Tb("");g.el=RegExp("\\b(url\\([ \t\n]*)('[ -&(-\\[\\]-~]*'|\"[ !#-\\[\\]-~]*\"|[!#-&*-\\[\\]-~]*)([ \t\n]*\\))","g");g.xca=RegExp("\\b(hsl|hsla|rgb|rgba|matrix|(rotate|scale|translate)(X|Y|Z|3d)?)\\([-0-9a-z.%, ]+\\)","g");g.Vb.prototype.Ud=!0;g.Ub={};g.Vb.prototype.Sc=function(){return this.C};
g.yca=g.Wb("");g.Yb.prototype.Jl=!0;g.Yb.prototype.C=function(){return this.D};
g.Yb.prototype.Ud=!0;g.Yb.prototype.Sc=function(){return this.F};
...
g.ol={sP:"click",WV:"rightclick",aQ:"dblclick",Qg:"mousedown",Rg:"mouseup",Vh:"mouseover",Uh:"mouseout",GT:"mousemove",ET:"mouseenter",FT:"mouseleave",Pg:"mousecancel",eW:"selectionchange",fW:"selectstart",QY:"wheel",LR:"keypress",KR:"keydown",MR:"keyup",lP:"blur",OQ:"focus",bQ:"deactivate",QQ:"focusin",RQ:"focusout",pP:"change",PV:"reset",dW:"select",HW:"submit",vR:"input",uV:"propertychange",xQ:"dragstart",sQ:"drag",uQ:"dragenter",wQ:"dragover",vQ:"dragleave",DROP:"drop",tQ:"dragend",SW:"touchstart",
RW:"touchmove",QW:"touchend",PW:"touchcancel",kP:"beforeunload",NP:"consolemessage",QP:"contextmenu",fQ:"devicechange",gQ:"devicemotion",hQ:"deviceorientation",kQ:"DOMContentLoaded",ERROR:"error",kR:"help",LOAD:"load",mT:"losecapture",oU:"orientationchange",zV:"readystatechange",RV:"resize",ZV:"scroll",fY:"unload",nP:"canplay",oP:"canplaythrough",yQ:"durationchange",BQ:"emptied",ENDED:"ended",hT:"loadeddata",iT:"loadedmetadata",PAUSE:"pause",PLAY:"play",PLAYING:"playing",xV:"ratechange",bW:"seeked",
cW:"seeking",DW:"stalled",JW:"suspend",NW:"timeupdate",qY:"volumechange",rY:"waiting",zW:"sourceopen",yW:"sourceended",xW:"sourceclosed",kO:"abort",UPDATE:"update",jY:"updatestart",hY:"updateend",iR:"hashchange",wU:"pagehide",xU:"pageshow",qV:"popstate",TP:"copy",FU:"paste",XP:"cut",eP:"beforecopy",fP:"beforecut",iP:"beforepaste",nU:"online",iU:"offline",MESSAGE:"message",MP:"connect",xR:"install",lO:"activate",MQ:"fetch",TQ:"foreignfetch",xT:"messageerror",EW:"statechange",iY:"updatefound",SP:"controllerchange",
VO:Cd("AnimationStart"),TO:Cd("AnimationEnd"),UO:Cd("AnimationIteration"),TW:g.nl,iV:"pointerdown",oV:"pointerup",hV:"pointercancel",lV:"pointermove",nV:"pointerover",mV:"pointerout",jV:"pointerenter",kV:"pointerleave",cR:"gotpointercapture",nT:"lostpointercapture",HT:"MSGestureChange",IT:"MSGestureEnd",JT:"MSGestureHold",KT:"MSGestureStart",LT:"MSGestureTap",NT:"MSGotPointerCapture",OT:"MSInertiaStart",PT:"MSLostPointerCapture",QT:"MSPointerCancel",RT:"MSPointerDown",ST:"MSPointerEnter",UT:"MSPointerHover",
VT:"MSPointerLeave",XT:"MSPointerMove",ZT:"MSPointerOut",aU:"MSPointerOver",bU:"MSPointerUp",TEXT:"text",MW:g.B?"textinput":"textInput",JP:"compositionstart",KP:"compositionupdate",IP:"compositionend",gP:"beforeinput",EQ:"exit",fT:"loadabort",gT:"loadcommit",jT:"loadredirect",kT:"loadstart",lT:"loadstop",SV:"responsive",vW:"sizechanged",gY:"unresponsive",mY:"visibilitychange",GW:"storage",pQ:"DOMSubtreeModified",lQ:"DOMNodeInserted",nQ:"DOMNodeRemoved",oQ:"DOMNodeRemovedFromDocument",mQ:"DOMNodeInsertedIntoDocument",
